...
DROP PROCEDURE IF EXISTS REPORTE_ALQUILER $
...
DROP PROCEDURE IF EXISTS REPORTE_TRANSACCCIONES_OFERTADOR $
...
DROP PROCEDURE IF EXISTS REPORTE_TRANSACCCIONES_RECEPTOR $
