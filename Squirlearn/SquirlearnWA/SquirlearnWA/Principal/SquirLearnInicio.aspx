<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SquirLearn.Master" AutoEventWireup="true" CodeBehind="SquirLearnInicio.aspx.cs" Inherits="SquirlearnWA.Principal.SquirLearnInicio" %>
                ...
                <div class="accordion" id="accordionFiltros">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseCategoria" class="accordion-collapse collapse" aria-labelledby="headingCategoria" data-bs-parent="#accordionFiltros">
                            <div class="accordion-body">
                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-select mb-2" AppendDataBoundItems="true">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseEstado" class="accordion-collapse collapse" aria-labelledby="headingEstado" data-bs-parent="#accordionFiltros">
                            <div class="accordion-body">
                            ...
                            <div class="col">
                                <div class="card h-100 shadow-sm border-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <asp:HyperLink ID="lnkSolicitar" runat="server" CssClass="btn btn-primary w-100 fw-semibold"
                                                       OnClick="btnSolcicitar_Clicks" Text="Solicitar" />
                                    </div>
                                </div>
                            </div>
                        </ItemTemplate>
