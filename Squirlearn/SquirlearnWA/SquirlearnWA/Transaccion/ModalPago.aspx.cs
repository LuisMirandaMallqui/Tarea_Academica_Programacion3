...
namespace SquirlearnWA.Transaccion
{
    public partial class ModalPago : System.Web.UI.Page
    {
        ...
        protected void btnConfirmar(object sender, EventArgs e)
        {
            ...
            //procesa el pago y se realiza la transacción , el producto y el alquiler se pasaron por session
            // if (procesaPago(numTrajeta, ano, mes, cvv, yape, codigo, producto, alquiler)){falla}
