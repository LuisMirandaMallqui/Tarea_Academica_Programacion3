...
namespace SquirlearnWA.personaSOAP {
    ...
    public partial class insertarPersonaRequest {
        ...
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public SquirlearnWA.personaSOAP.date creadorId;
        
        public insertarPersonaRequest() {
        }
        
        public insertarPersonaRequest(string nombres, string primerApellido, string segundoApellido, string codigo, string correo, string contrasena, string usuario, SquirlearnWA.personaSOAP.date creadorId) {
    ...
    public partial class modificarPersonaRequest {
        ...
        public modificarPersonaRequest(int id, string nombres, string primerApellido, string segundoApellido, string codigo, string correo, string contrasena, int estadoId, string usuario, string usuarioCreacion, SquirlearnWA.personaSOAP.date creadorId) {
            this.id = id;
            this.nombres = nombres;
            this.primerApellido = primerApellido;
            this.segundoApellido = segundoApellido;
    ...
    public partial class PersonaClient : System.ServiceModel.ClientBase<SquirlearnWA.personaSOAP.Persona>, SquirlearnWA.personaSOAP.Persona {
        ...
        public int insertarPersona(string nombres, string primerApellido, string segundoApellido, string codigo, string correo, string contrasena, string usuario, SquirlearnWA.personaSOAP.date creadorId) {
        ...
        public System.Threading.Tasks.Task<SquirlearnWA.personaSOAP.insertarPersonaResponse> insertarPersonaAsync(string nombres, string primerApellido, string segundoApellido, string codigo, string correo, string contrasena, string usuario, SquirlearnWA.personaSOAP.date creadorId) {
            SquirlearnWA.personaSOAP.insertarPersonaRequest inValue = new SquirlearnWA.personaSOAP.insertarPersonaRequest();
            inValue.nombres = nombres;
            inValue.primerApellido = primerApellido;
            inValue.segundoApellido = segundoApellido;
        ...
        public int modificarPersona(int id, string nombres, string primerApellido, string segundoApellido, string codigo, string correo, string contrasena, int estadoId, string usuario, string usuarioCreacion, SquirlearnWA.personaSOAP.date creadorId) {
        ...
        public System.Threading.Tasks.Task<SquirlearnWA.personaSOAP.modificarPersonaResponse> modificarPersonaAsync(int id, string nombres, string primerApellido, string segundoApellido, string codigo, string correo, string contrasena, int estadoId, string usuario, string usuarioCreacion, SquirlearnWA.personaSOAP.date creadorId) {
            SquirlearnWA.personaSOAP.modificarPersonaRequest inValue = new SquirlearnWA.personaSOAP.modificarPersonaRequest();
            inValue.id = id;
            inValue.nombres = nombres;
            inValue.primerApellido = primerApellido;
