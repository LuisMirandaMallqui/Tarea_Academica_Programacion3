                        ...
                        <div id="collapseEntrega" class="accordion-collapse collapse show" aria-labelledby="headingEntrega" data-bs-parent="#accordionFiltros">
                            <div class="accordion-body">
                                <div class="form-check mb-2">
                                    ...
                                    <label class="form-check-label small label-terminos">Venta</label>
                                </div>
                                <div class="form-check">
                                    <asp:RadioButton ID="rbAlquiler" GroupName="Entrega" runat="server" CssClass="chk-terminos" />
                                    <label class="form-check-label small label-terminos">Alquiler</label>
                                </div>
                            </div>
                        </div>
                    </div>
