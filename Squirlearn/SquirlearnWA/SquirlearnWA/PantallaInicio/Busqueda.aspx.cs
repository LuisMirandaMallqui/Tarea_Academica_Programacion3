...
namespace SquirlearnWA.PantallaInicio
{
    public partial class Busqueda : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
               ...
               int categoriaId = Convert.ToInt32(Session["idCategoria"]);
                ...
                IList<publicacionDto> publicaciones = publicacionSoap.listaPorFiltroPublicacion(null, null, categoriaId, null, null, null, null);
        ...
        private void CargarFiltros()
        {
            ...
            // Formatos
            IList<fomatoSOAP.formatoDto> formatos = formatoSoap.listarTodosFormato();
        ...
        private void BuscarProductos()
        {
            ...
            string tipoTransaccion = rbVenta.Checked ? "Venta" : rbAlquiler.Checked ? "Alquiler" : null;
            string categoriaId = ddlCategoria.SelectedValue ?? null;
            string condicion = rblCondicion.SelectedValue ?? null;
            string formato = rblFormato.SelectedValue ?? null;
            string tamano = rblTamano.SelectedValue ?? null;
            string color = ddlColor.SelectedValue ?? null;
            IList<publicacionDto> publicaciones = publicacionSoap.listaPorFiltroPublicacion(terminoBusqueda, tipoTransaccion, categoriaId, condicion, formato, tamano, color);
