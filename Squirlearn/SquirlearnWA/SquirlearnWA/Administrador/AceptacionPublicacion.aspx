<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SquirLearn.Master" AutoEventWireup="true" CodeBehind="AceptacionPublicacion.aspx.cs" Inherits="SquirlearnWA.Administrador.AceptacionPublicacion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <i class="fa fa-arrow-left"></i>
     ...
     <!-- Título -->
     <h2 class="text-center fw-bold mb-4">ACEPTACIÓN DE PUBLICACIÓN</h2>
