<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SquirLearn.Master" AutoEventWireup="true" CodeBehind="IncidenciasAdmin.aspx.cs" Inherits="SquirlearnWA.Administrador.IncidenciasAdmin" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-between">
                                    ...
                                    <span>
                                        <asp:Label ID="lblMotivo" runat="server"></asp:Label></span>
                                </div>
                            </td>
