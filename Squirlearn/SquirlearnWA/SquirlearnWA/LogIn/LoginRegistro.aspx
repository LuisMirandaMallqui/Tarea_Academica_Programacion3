    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="card shadow p-4" style="width: 600px;">
            ...
            <asp:Panel ID="pnlRegistro" runat="server">
                ...
                <div class="mb-3">
                    <label for="txtPrimerApellido" class="fw-semibold">¿Cuál es tu primer apellido?</label>
                    <asp:TextBox ID="txtPrimerApellido" runat="server" CssClass="form-control"
                        placeholder="Primer Apellido"></asp:TextBox>
                </div>

                <div class="mb-3">
                    <label for="txtSegundoApellido" class="fw-semibold">¿Cuál es tu segundo apellido?</label>
                    <asp:TextBox ID="txtSegundoApellido" runat="server" CssClass="form-control"
                        placeholder="Segundo Apellido"></asp:TextBox>
                </div>
