...
public class CategoriaDaoImpl extends DAOImplBase implements CategoriaDao{
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setDate(i++, this.categoria.getFechaCreacion());
        this.statement.setInt(i++, this.categoria.getUsuarioCreacion());
        this.statement.setDate(i++, this.categoria.getFechaModificacion());
        this.statement.setInt(i++, this.categoria.getUsuarioModificacion());
    }
