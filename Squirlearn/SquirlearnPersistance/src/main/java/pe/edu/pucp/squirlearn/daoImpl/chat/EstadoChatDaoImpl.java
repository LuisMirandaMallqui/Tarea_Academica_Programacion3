...
public class EstadoChatDaoImpl extends DAOImplBase implements EstadoChatDao{
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setDate(i++, this.estadoChat.getFechaCreacion());
        this.statement.setInt(i++, this.estadoChat.getUsuarioCreacion());
        this.statement.setDate(i++, this.estadoChat.getFechaModificacion());
        this.statement.setInt(i++, this.estadoChat.getUsuarioModificacion());
    }
