...
public class FormatoDaoImpl extends DAOImplBase implements FormatoDao{
   ...
   @Override
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setDate(i++, this.formato.getFechaCreacion());
        this.statement.setInt(i++, this.formato.getUsuarioCreacion());
        this.statement.setDate(i++, this.formato.getFechaModificacion());
        this.statement.setInt(i++, this.formato.getUsuarioModificacion());
    }
