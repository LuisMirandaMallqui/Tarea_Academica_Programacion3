...
public class TamañoDaoImpl extends DAOImplBase implements TamañoDao{
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setDate(i++, this.tamaño.getFechaCreacion());
        this.statement.setInt(i++, this.tamaño.getUsuarioCreacion());
        this.statement.setDate(i++, this.tamaño.getFechaModificacion());
        this.statement.setInt(i++, this.tamaño.getUsuarioModificacion());
    }
