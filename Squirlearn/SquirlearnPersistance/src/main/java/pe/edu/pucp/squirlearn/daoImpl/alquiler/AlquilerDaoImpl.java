...
public class AlquilerDaoImpl extends DAOImplBase implements AlquilerDao{
    ...
    this.statement.setInt(idx++, this.alquiler.getUsuarioCreacion());
    this.statement.setDate(idx++, this.alquiler.getFechaModificacion());
    this.statement.setInt(idx++, this.alquiler.getUsuarioModificacion());
}
    ...
    protected void incluirValorDeParametrosParaModificacion() throws SQLException {
        ...
        this.statement.setDate(i++, this.alquiler.getFechaCreacion());      // FECHA_CREACION=?
        this.statement.setInt(i++, this.alquiler.getUsuarioCreacion());          // USUARIO_CREACION=?
        this.statement.setDate(i++, this.alquiler.getFechaModificacion());  // FECHA_MODIFICACION=?
        this.statement.setInt(i++, this.alquiler.getUsuarioModificacion());      // USUARIO_MODIFICACION=?
