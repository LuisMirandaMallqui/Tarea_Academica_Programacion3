...
public class SubcategoriaDaoImpl extends DAOImplBase implements SubcategoriaDao{
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setDate(i++, this.subcategoria.getFechaCreacion());
        this.statement.setInt(i++, this.subcategoria.getUsuarioCreacion());
        this.statement.setDate(i++, this.subcategoria.getFechaModificacion());
        this.statement.setInt(i++, this.subcategoria.getUsuarioModificacion());
    }
