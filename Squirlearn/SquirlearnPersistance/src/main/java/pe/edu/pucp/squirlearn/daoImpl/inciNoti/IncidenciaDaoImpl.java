...
public class IncidenciaDaoImpl extends DAOImplBase implements IncidenciaDao{
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setDate(i++, this.incidencia.getFechaCreacion());
        ...
        this.statement.setInt(i++, this.incidencia.getUsuarioCreacion());
        this.statement.setObject(i++, this.incidencia.getUsuarioSolucion(), java.sql.Types.INTEGER);
        this.statement.setDate(i++, this.incidencia.getFechaModificacion());
        this.statement.setObject(i++, this.incidencia.getUsuarioModificacion(), java.sql.Types.INTEGER);
    ...
    protected void instanciarObjetoDelResultSet() throws SQLException {
        ...
        // Escalares
        this.incidencia.setIncidenciaDto(this.resultSet.getInt("INCIDENCIA_ID"));
        ...
        this.incidencia.setUsuarioModificacion((Integer) this.resultSet.getObject("USUARIO_MODIFICACION"));
