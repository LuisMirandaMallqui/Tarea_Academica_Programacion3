...
public class EstadoPublicacionDaoImpl extends DAOImplBase implements EstadoPublicacionDao{
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setDate(i++, this.estadoPublicacion.getFechaCreacion());
        this.statement.setInt(i++, this.estadoPublicacion.getUsuarioCreacion());
        this.statement.setDate(i++, this.estadoPublicacion.getFechaModificacion());
        this.statement.setInt(i++, this.estadoPublicacion.getUsuarioModificacion());
    }
