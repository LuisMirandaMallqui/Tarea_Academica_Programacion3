...
public class MonedaPagoDaoImpl extends DAOImplBase implements MonedaPagoDao{
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        this.statement.setString(1, this.monedaPago.getNombre());
        this.statement.setDate(2, (Date) this.monedaPago.getFechaCreacion());
        this.statement.setInt(3, this.monedaPago.getUsuarioCreacion());
        this.statement.setDate(4, (Date) this.monedaPago.getFechaModificacion());
        this.statement.setInt(5, this.monedaPago.getUsuarioModificacion());
    }
    ...
    protected void incluirValorDeParametrosParaModificacion() throws SQLException {
        ...
        this.statement.setDate(4, (Date) this.monedaPago.getFechaModificacion());
        this.statement.setInt(5, this.monedaPago.getUsuarioModificacion());
        this.statement.setInt(6, this.monedaPago.getMonedaId());
    }
