...
public class EstadoPersonaDaoImpl extends DAOImplBase implements EstadoPersonaDao{
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setDate(i++, this.estadoPersona.getFechaCreacion());
        this.statement.setInt(i++, this.estadoPersona.getUsuarioCreacion());
        this.statement.setDate(i++, this.estadoPersona.getFechaModificacion());
        this.statement.setInt(i++, this.estadoPersona.getUsuarioModificacion());
    }
