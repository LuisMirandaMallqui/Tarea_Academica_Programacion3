...
public class Alquiler {
    ...
    public Integer insertarAlquiler(
            ...
            @WebParam(name = "fechaInicio")String inicio,
            @WebParam(name = "fechaFin") String fin , 
    ...
    public Integer modificarAlquiler(
        ...
        return this.alquilerBo.Modificar(id, personaId, itemId, inicio, fin, monto, devuelto);
    }
